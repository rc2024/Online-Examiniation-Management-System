...
public class FacultyUploadExam extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select c.COURSE_NAME, c.COURSE_ID from COURSES c,EXAMS E WHERE E.COURSEID!=C.COURSE_ID");
    	...
    	out.print("<br><br><input type=\"submit\" name=\"submit\" value=\"Upload\">");
