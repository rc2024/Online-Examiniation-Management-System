...
public class FacultyRemoveExam extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select COURSE_NAME, COURSEID from EXAMS E ");
		...
		out.print("        </div>  ");
		out.print("        <div class=\"info\"><center><form method=\"post\" action=\"FacultyRemoveExamDb\">");
    	...
    	out.print("<br><br><input type=\"submit\" name=\"submit\" value=\"Remove\">");
