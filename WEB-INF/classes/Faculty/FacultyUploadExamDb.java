...
public class FacultyUploadExamDb extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<html>");
		out.print("<head>");
		out.print("		<title>Faculty Upload Course</title>");
		...
		try{
			...
			PreparedStatement pst=con.prepareStatement("select COURSE_NAME from COURSES WHERE COURSE_ID=?");
			pst.setString(1,cid);
		...
		out.print("<font color=\"green\">Exam uploaded Successfully");
