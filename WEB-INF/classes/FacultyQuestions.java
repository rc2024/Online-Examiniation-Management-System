...
public class FacultyQuestions extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<html>");
		out.print("<head>");
		out.print("		<title>Faculty View Questons`</title>");
...
//Body
		...
		out.print("        </div>  ");
		out.print("        <div class=\"info\"><center><form action=\"FacultyViewQuestions\" method=\"post\"><select  id=\"course\" name=\"course\">");
        
		while(rs.next())
		{
			out.print("<option value=\""+rs.getString(2)+"\">"+rs.getString(1)+"</option>");
		}
        out.print("</select><br><br><input type=\"Submit\" Value=\"View\"></form>  ");
