...
public class FacultyAddQuestions extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select count(question) from QUESTIONS where COURSEID=?");
			ps.setString(1,cid);
		...
		out.print("        </div>  ");
		out.print("        <div class=\"info\"><center>Add Question<form method=\"post\" action=\"FacultyAddQuestionsDb\">");
        out.print("<br>Question Number:&nbsp&nbsp");out.print((rs.getInt(1)+1));
        out.print("<br>Question:&nbsp&nbsp");out.print("<textarea name=\"qn\" autofocus ></textarea>");
        out.print("<br>Option 1:&nbsp&nbsp");out.print("<input type=\"text\" name=\"op1\" >");
        out.print("<br>Option 2:&nbsp&nbsp");out.print("<input type=\"text\" name=\"op2\" >");
        out.print("<br>Option 3:&nbsp&nbsp");out.print("<input type=\"text\" name=\"op3\" >");
        out.print("<br>Option 4:&nbsp&nbsp");out.print("<input type=\"text\" name=\"op4\" >");

        out.print("<br> Correct Option:&nbsp&nbsp");
        out.print("<input type=\"radio\" name=\"cop\" value=\"op1\">Option 1&nbsp&nbsp");
        out.print("<input type=\"radio\" name=\"cop\" value=\"op2\">Option 2&nbsp&nbsp");
        out.print("<input type=\"radio\" name=\"cop\" value=\"op3\">Option 3&nbsp&nbsp");
        out.print("<input type=\"radio\" name=\"cop\" value=\"op4\">Option 4&nbsp&nbsp");

    	out.print("<br><br><input type=\"submit\" name=\"submit\" value=\"Add Question\">");
