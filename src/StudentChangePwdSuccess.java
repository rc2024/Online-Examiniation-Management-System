...
public class StudentChangePwdSuccess extends HttpServlet {
...
//Body
        ...
        session.setAttribute("uname",n);out.println("<font color=\"Green\">Password Changed Successful</font>");
...
//Body
		...
		out.print("            <li><a href=\"StudentSubjects\">Subjects</a></li>");
