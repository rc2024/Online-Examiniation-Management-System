...
public class FacultyChangePwdValidate extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("SELECT PASSWORD FROM Faculty_Online where USERNAME=?");
			ps.setString(1,n);
...
//Body
		...
		if(oldpass.equals(p))
		{
			PreparedStatement psupdate=con.prepareStatement("UPDATE Faculty_Online SET PASSWORD=? where USERNAME=?");
